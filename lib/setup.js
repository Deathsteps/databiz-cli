...
function basicSetup (templatesPath, projectPath) {
  ...
  shell.cp('-rf', path.join(templatesPath, 'basic/common'), srcPath)
  shell.cp('-rf', path.join(templatesPath, 'basic/components'), srcPath)
  shell.cp('-rf', path.join(templatesPath, 'basic/models'), srcPath)
  shell.cp('-rf', path.join(templatesPath, 'basic/views'), srcPath)
  shell.cp('-f', path.join(templatesPath, 'basic/*.js'), srcPath)
...
function useAntd (templatesPath, projectPath) {
  ...
  // basic framework
  shell.cp('-rf', path.join(templatesPath, 'antd/components'), srcPath)
  shell.cp('-rf', path.join(templatesPath, 'antd/layouts'), srcPath)
  shell.cp('-rf', path.join(templatesPath, 'antd/models'), srcPath)
  shell.cp('-rf', path.join(templatesPath, 'antd/static'), srcPath)
  shell.cp('-rf', path.join(templatesPath, 'antd/views'), srcPath)
  shell.cp('-f', path.join(templatesPath, 'antd/*.js'), srcPath)
  shell.cp('-f', path.join(templatesPath, 'antd/*.less'), srcPath)
